<template>
  <div class="shop-header">
    ...
    <div class="shop-content" @click="isShopShow=!isShopShow">
    ...
    <div class="shop-header-discounts"v-if="shopInfo.supports" @click="isActivityShow=!isActivityShow">
      ...
      <div class="shop-brief-modal" v-show="isShopShow">
        <div class="brief-modal-content">
         ...
         <ul class="brief-modal-msg">
          ...
          <div class="mask-footer" @click="isShopShow=!isShopShow">
    ...
    <transition name="move">
      <div class="activity-sheet" v-show="isActivityShow">
        <div class="activity-sheet-content">
          ...
          <div class="activity-sheet-close" @click="isActivityShow=!isActivityShow">
            <span class="iconfont icon-close"></span>
          </div>
        </div>
